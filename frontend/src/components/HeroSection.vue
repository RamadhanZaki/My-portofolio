...
<section id="profil" class="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
  <div class="md:w-1/2 mb-10 md:mb-0">
    ...
    200ms;">
      Halo, Saya <span class="text-blue-600">Ramadhan Zaki</span>
    </h1>
  ...
  <div class="md:w-1/2 flex justify-center animate-slide-in-right">
    <img :src="jukii" alt="Foto Profil" class="w-80 h-80 rounded-full object-cover shadow-lg">
  </div>
</section>
</template>

<script setup>
import jukii from '@/assets/jukii.webp'
</script>
